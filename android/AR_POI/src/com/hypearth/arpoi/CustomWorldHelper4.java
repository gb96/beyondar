...
public class CustomWorldHelper4 {
    ...
    public static World generateObjects(Context context) {
        Log.i(CustomWorldHelper4.class.getName(), "generateObjects");
        ...
        Log.i(CustomWorldHelper4.class.getName(), "generateObjects() attempting to get History SA data");
            ...
            final JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(final JSONObject response) {
                            Log.d(CustomWorldHelper4.class.getName(), response.toString());
                            pDialog.hide();

                            Log.i(CustomWorldHelper4.class.getName(), "Got History SA " + url + "s...");
                            try {
                                final JSONArray features = response.getJSONArray("features");
                                if (features != null) {
                                    Log.i(CustomWorldHelper4.class.getName(), "Got History SA " + url + " Features, count=" + features.length());
                                ...
                                Log.e(CustomWorldHelper4.class.getName(), "Problem fetching GEOJSON \" + url + \" from HistorySA", e);
                            }
                        }
                ...
                public void onErrorResponse(VolleyError error) {
                    VolleyLog.d(CustomWorldHelper4.class.getName(), "Error: " + error.getMessage());
                    pDialog.hide();
                }
            }) {
            };
