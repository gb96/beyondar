...
public class Iteration4 extends FragmentActivity implements OnSeekBarChangeListener, View.OnClickListener, LocationListener, OnClickBeyondarObjectListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRadarPlugin.setListColor(CustomWorldHelper4.LIST_TYPE_EVENT_CODE, Color.RED);
        mRadarPlugin.setListColor(CustomWorldHelper4.LIST_TYPE_ORGANISATION_CODE, Color.GREEN);
        mRadarPlugin.setListColor(CustomWorldHelper4.LIST_TYPE_PLACE_CODE, Color.YELLOW);
        mRadarPlugin.setListColor(CustomWorldHelper4.LIST_TYPE_THING_CODE, Color.BLUE);
    ...
    private void loadViewFromXML() {
        Log.i(Iteration4.class.getName(), "loadViewFromXML() start");
        ...
        Log.i(Iteration4.class.getName(), "loadViewFromXML() done");
    }
